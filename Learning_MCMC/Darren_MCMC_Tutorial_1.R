...
# metrop2 <- function(n = 1000, eps = 0.5, x0 = 0, myfun){
...
# 
# 
# mcmc_out <- metrop2(n = 5000, eps = 1, x0 = 5, myfun = unkownfun1)
# plot_mcmc(mcmc_out)
# 
# 
# metrop3 <- function(n = 1000, eps = 0.5, x0 = 0, myfun){
#   vec <- vector("numeric",n)
#   x = x0
#   oldloglik = log(myfun(x))
#   for (i in 2:n){
#     innov = runif(1,-eps,eps)
#     can = x + innov
#     canloglik = log(myfun(can))
...
# 
# 
# # mcmc_out <- metrop3(n = 10000, eps = 1, x0 = 5, myfun = unkownfun1)
# # plot_mcmc(mcmc_out)
# 
# 
